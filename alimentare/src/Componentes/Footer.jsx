  ...
  <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <a href="/" className="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
     ...
     <ul className="nav col-md-4 justify-content-end">
      ...
      <li className="nav-item"><a href="/Recetas" className="nav-link px-2 text-body-secondary">Agendas</a></li>
      <li className="nav-item"><a href="/Alimentos" className="nav-link px-2 text-body-secondary">Cuadernos</a></li>
      <li className="nav-item"><a href="/Login" className="nav-link px-2 text-body-secondary">Calendarios</a></li>
